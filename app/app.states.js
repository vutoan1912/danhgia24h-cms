    ...
    .config([
        ...
        function ($stateProvider, $urlRouterProvider, $locationProvider) {
            ...
            $stateProvider
                    ...
                    .state("error.401", {
                        url: "/401",
                        templateUrl: 'app/components/pages/error_401View.html',
                        controller: 'errorCtrl',
                        resolve: {
                            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                                    return $ocLazyLoad.load('app/components/pages/errorController.js');
                                }]
                        }
                    })
                    .state("error.500", {
                    ...
                    //module leads CF
                    .state("restricted.leadscf", {
                        url: "/leadscf",
                        template: '<div ui-view autoscroll="false"/>',
                        abstract: true
                    })
                    .state("restricted.leadscf.crud", {
                        url: "/crud",
                        templateUrl: 'app/components/vpcus/leadscf/leadscfView.html',
                        controller: 'leadscfCtrl',
                        resolve: {
                            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        'lazy_KendoUI',
                                        'app/components/vpcus/leadscf/leadscfService.js',
                                        'lazy_pagination',
                                        'app/components/vpcus/leadscf/leadscfController.js'
                                    ]);
                                }],
                            translatePartialLoader: ['$translate', '$translatePartialLoader', function ($translate, $translatePartialLoader) {
                                $translatePartialLoader.addPart('leadscf');
                                return $translate.refresh();
                            }]
                        },
                        data: {
                    ...
                    .state("restricted.opportunities", {
                        url: "/opportunities",
                        template: '<div ui-view autoscroll="false"/>',
                        abstract: true
                    })
                    .state("restricted.opportunities.info", {
                        url: "/info",
                        templateUrl: 'app/components/vpcus/opportunities/opportunitiesView.html',
                        controller: 'opportunitiesCtrl',
                        resolve: {
                            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                                    return $ocLazyLoad.load('app/components/vpcus/opportunities/opportunitiesController.js');
                                }]
                        },
                        data: {
                    ...
                    .state("restricted.svrequest", {
                        url: "/svrequest",
                        template: '<div ui-view autoscroll="false"/>',
                        abstract: true
                    })
                    .state("restricted.svrequest.ticket", {
                        url: "/ticket",
                        templateUrl: 'app/components/vpcus/svrequest/ticket/svrequestTicketView.html',
                        controller: 'svrequestTicketCtrl',
                        resolve: {
                            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                                return $ocLazyLoad.load([
                                    'app/components/vpcus/svrequest/ticket/svrequestTicketService.js',
                                    'lazy_pagination',
                                    'app/components/vpcus/svrequest/ticket/svrequestTicketController.js'
                                ]);
                            }],
                            translatePartialLoader: ['$translate', '$translatePartialLoader', function ($translate, $translatePartialLoader) {
                                $translatePartialLoader.addPart('service-request-ticket');
                                return $translate.refresh();
                            }]
                        },
                        data: {
                    ...
                    //module tool AF
                    .state("restricted.tools", {
                        url: "/toolaf",
                        template: '<div ui-view autoscroll="false"/>',
                        abstract: true
                    })
                    .state("restricted.tools.toolaf", {
                        url: "/toolaf",
                        templateUrl: 'app/components/vpcus/tools/toolaf/toolsToolafView.html',
                        controller: 'toolsToolafCtrl',
                        resolve: {
                            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                                return $ocLazyLoad.load([
                                    'app/components/vpcus/tools/toolaf/toolsToolafService.js',
                                    'lazy_pagination',
                                    'app/components/vpcus/tools/toolaf/toolsToolafController.js'
                                ]);
                            }],
                            translatePartialLoader: ['$translate', '$translatePartialLoader', function ($translate, $translatePartialLoader) {
                                $translatePartialLoader.addPart('tools-toolaf');
                                return $translate.refresh();
                            }]
                        },
                        data: {
