altairApp
    .service('svrequestTicketService',
        function ($rootScope, $q, $http, API_URL_2, HttpVtgServices, $filter) {
            var self = {
                'page': 1,
                'limit': 15,
                'table': [],
                ...
                'load': function (params) {
                    console.log(params);
                    HttpVtgServices.getData(API_URL_2 + 'com=service&elem=vtg_957&func=doSearch', params)
