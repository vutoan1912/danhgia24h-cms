...
altairApp
            ...
            return {
                ...
                link: function() {
                    var listener = function(event, toState) {
                        var default_title = 'VPBank Admin';
                        $timeout(function() {
    ...
    //toanvd2 - 2018/10/29
    .directive('downloadAsExcel', function($compile, $sce, $templateRequest, $q) {
        return {
            restrict: 'E',
            scope: {
                template: '@',
            ...
            replace: true,
            template: '<a class="md-btn" type="button" style="width: 125px;" data-uk-button>{{textButton}}</a>',
            link: function(scope, element, attrs) {
                var contentType = 'data:application/vnd.ms-excel;base64';
                var htmlS = '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" >' +
